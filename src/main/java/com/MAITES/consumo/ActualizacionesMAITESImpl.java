...
public class ActualizacionesMAITESImpl implements IActualizacionesMAITES {

	@Override
	public List<String> ListadoDeId() {
	...
	@Override
	public List<String> ActualizarPlanta(int id) {
	...
	private ResponseEntity<String> Consumidora(String urlDeConsumo) {
